...
$extra_info = $install_info = '<a href="http://forum.coppermine-gallery.net/index.php/topic,74690.0.html" rel="external" class="admin_menu">'.cpg_fetch_icon('announcement', 1).$lang_plugin_hot_pictures['announcement_thread'].'</a>';
