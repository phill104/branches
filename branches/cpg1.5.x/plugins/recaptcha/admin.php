...
echo <<< EOT
			<tr>
			<td class="tableb">
			<br /><b> {$recap_lang['page_heading']} </b>
			</td>
			</tr>
			<tr>
			<td></td>
			...
			<td>
			<br />
			<select name="sawey_recaptcha_lang" id="sawey_recaptcha_lang">
			...
			<tr>
			<td class="tableb"> <hr> {$recap_lang['update_style']} 
			...
			<td>
			<br />
         	<select name="sawey_recaptcha_style" id="sawey_recaptcha_style">
			...
			<tr>
			<td class="tableb"> <hr> {$recap_lang['update_contact']}
			...
			<tr>
			<td class="tableb"> <hr> {$recap_lang['commenthelp']}
			...
			<tr>
			<td class="tableb"> <hr> {$recap_lang['contacthelp']}
			...
			<tr>
			<td class="tableb"> <hr> {$recap_lang['reghelp']}
			...
			<tr>
			<td class="tableb"> <hr> {$recap_lang['recaptcha_rows']}
            ...
            <td class="tableb">
			<hr>
			{$recap_lang['recaptcha_key']} <a href="plugins/recaptcha/docs/{$documentation_file}.htm#recaptcha_key" class="greybox" title="{$recap_lang['recaptcha_key']}"><img src="images/help.gif" width="13" height="11" border="0" alt="" /></a>
            </td>
			</tr>			
		    <tr>			
            <td>
			<br />
            <input type="text" size="60" maxlength="250" class="textinput" style="width:90%" name="sawey_recaptcha_key" id="sawey_recaptcha_key"  value="{$option_output['recapt_key']}" />
            </td>
			</tr>
            <tr>
            <td class="tableb">
			<hr>
			{$recap_lang['recaptcha_privkey']} <a href="plugins/recaptcha/docs/{$documentation_file}.htm#recaptcha_privkey" class="greybox" title="{$recap_lang['recaptcha_privkey']}"><img src="images/help.gif" width="13" height="11" border="0" alt="" /></a>
            </td>
			</tr>			
		    <tr>			
            <td>
			<br />
            <input type="text" size="60" maxlength="250" class="textinput" style="width:90%" name="sawey_recaptcha_privkey" id="sawey_recaptcha_privkey"  value="{$option_output['recapt_privkey']}" />
            </td>
			</tr>
			<tr>			
	       <td class="tableb" align="right"><br /><br />
			...
			<input type="submit" name="submit" value="{$recap_lang['submit_change']}" /> 
		</span>
		</td>
		</tr>
		</td>		
